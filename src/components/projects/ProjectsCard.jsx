...
const projects = [
  {
    ...
    typeTag: "Freelance: Client Project",
  ...
  return (
    <BackgroundGradient className="rounded-[22px] max-w-sm bg-gradient-to-bl from-customColor2 to-customColor1 p-2">
      <div className="flex flex-col gap-2 relative group p-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100 bg-black/90 rounded-[22px]">
          <div className="flex w-full max-w-[520px] flex-col items-center justify-center gap-6 px-6 text-center">
            <span className="rounded-full bg-customColor7/70 px-4 py-2 text-sm font-semibold text-customColor4 shadow-lg shadow-customColor1/30">
              {project.typeTag}
            </span>

            <p className="text-customColor5 text-sm lg:text-base text-pretty text-left">
              {project.description}
            </p>
            ...
            <div className="flex w-full flex-col items-center gap-4">
              {project.url && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="relative inline-flex h-12 overflow-hidden rounded-2xl p-[1px] w-full max-w-[320px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
                >
                  <span className="absolute inset-[-1000%] animate-&lsqb;spin_2s_linear_infinite&rsqb bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#160e2b_50%,#E2CBFF_100%)]" />
              ...
              {project.video && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="relative inline-flex h-12 overflow-hidden rounded-2xl p-[1px] w-full max-w-[320px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-sm lg:text-base"
                >
